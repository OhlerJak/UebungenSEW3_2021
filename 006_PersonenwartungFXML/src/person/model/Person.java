...
public final class Person implements Serializable {
  ...
  /**
   * Selektiert die Person mit der geg. SVNR aus dem Objektkatalog.
   *
   * @param svnr gegebene SVNR
   * @return gesuchte Person oder null, wenn keine vorhanden
   */
  public static Person selectBySvnr(String svnr) {
    return catalog.selectBySvnr(svnr);
  }
